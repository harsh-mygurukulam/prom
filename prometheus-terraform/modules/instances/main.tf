#resource "aws_instance" "public_instance" {
 ...
 # iam_instance_profile = data.aws_iam_instance_profile.prometheus_instance_profile.name  # ✅ IAM Role Attach Ho Raha Hai
#
...
#  name = "PrometheusEC2Policy"  # AWS me jo policy ka naam hai
#}

# Pehle se existing IAM Instance Profile ko fetch kar raha hai
#data "aws_iam_instance_profile" "prometheus_instance_profile" {
 # name = "PrometheusInstanceProfile"  # AWS me jo instance profile ka naam hai
#}
